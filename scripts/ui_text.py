...
TEXTS: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "status.training_stopped": "训练已停止。已运行: {elapsed}",
        "status.training_finished": "训练完成。输出目录: {run_dir} | 总耗时: {elapsed}",
        "status.training_failed": "训练失败。已运行: {elapsed}",
        "status.stop_requested": "正在请求停止训练...",
        "status.training_starting": "训练启动中...",
        "timer.idle": "训练耗时: --:--:--",
        "timer.running": "训练耗时: {elapsed}",
        "timer.finished": "总耗时: {elapsed}",
        "timer.stopped": "已运行: {elapsed}",
        "timer.failed": "截至异常: {elapsed}",
        "resume.section_title": "继续训练 / Resume Training",
        "resume.description": "从中断的 checkpoint 继续训练。留空则按普通训练从头开始。可浏览常见 .pt / .pth 文件，也可手动输入其他现有 checkpoint 路径。",
        "resume.mode_fresh": "当前模式: 普通训练（从头开始）",
        "resume.mode_resume": "当前模式: 继续训练 | checkpoint={path}",
        "section.basic": "基础训练",
        ...
        "log.training_stopped": "\n[UI] 训练已停止: {reason} | 已运行 {elapsed}\n",
        "log.training_finished": "\n[UI] 训练完成，输出目录: {run_dir} | 总耗时: {elapsed}\n",
        "log.training_failed": "\n[UI] 训练失败: {error} | 已运行 {elapsed}\n",
        "log.training_mode_fresh": "[UI] 训练模式: fresh training\n",
        "log.training_mode_resume": "[UI] 训练模式: resume training | checkpoint={path}\n",
        "log.user_stop_requested": "[UI] 用户请求停止训练 | phase={phase} | scope={scope} | elapsed={elapsed}\n",
        ...
        "dialog.resume_checkpoint_not_found_detail": "续训 checkpoint 不存在: {path}",
        "dialog.resume_checkpoint_not_file_detail": "续训 checkpoint 不是有效文件: {path}",
    ...
    "en": {
        ...
        "status.training_stopped": "Training stopped. Elapsed: {elapsed}",
        "status.training_finished": "Training finished. Output directory: {run_dir} | Total elapsed: {elapsed}",
        "status.training_failed": "Training failed. Elapsed: {elapsed}",
        "status.stop_requested": "Stop requested...",
        "status.training_starting": "Starting training...",
        "timer.idle": "Elapsed: --:--:--",
        "timer.running": "Elapsed: {elapsed}",
        "timer.finished": "Total elapsed: {elapsed}",
        "timer.stopped": "Elapsed: {elapsed}",
        "timer.failed": "Elapsed before failure: {elapsed}",
        "resume.section_title": "Resume Training",
        "resume.description": "Resume training from an interrupted checkpoint. Leave this empty to keep normal fresh training. You can browse common .pt / .pth files or type another existing checkpoint path manually.",
        "resume.mode_fresh": "Current mode: fresh training",
        "resume.mode_resume": "Current mode: resume training | checkpoint={path}",
        ...
        "log.training_stopped": "\n[UI] Training stopped: {reason} | elapsed {elapsed}\n",
        "log.training_finished": "\n[UI] Training finished. Output directory: {run_dir} | total elapsed: {elapsed}\n",
        "log.training_failed": "\n[UI] Training failed: {error} | elapsed {elapsed}\n",
        "log.training_mode_fresh": "[UI] Training mode: fresh training\n",
        "log.training_mode_resume": "[UI] Training mode: resume training | checkpoint={path}\n",
        "log.user_stop_requested": "[UI] User requested stop | phase={phase} | scope={scope} | elapsed={elapsed}\n",
        ...
        "dialog.resume_checkpoint_not_found_detail": "Resume checkpoint does not exist: {path}",
        "dialog.resume_checkpoint_not_file_detail": "Resume checkpoint is not a valid file: {path}",

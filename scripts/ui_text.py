...
OPTION_TEXTS: dict[str, dict[str, dict[str, str]]] = {
    "zh": {
        ...
        "training.compile_mode": {"name": "编译模式", "desc": "torch.compile 的模式，例如 reduce-overhead。"},
    ...
    "en": {
        ...
        "training.compile_mode": {"name": "Compile Mode", "desc": "torch.compile mode such as reduce-overhead or max-autotune."},
